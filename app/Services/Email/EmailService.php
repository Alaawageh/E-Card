...
class EmailService
{
    public static function sendHtmlEmail($recipientEmail,$userCode,$userName, $userEmail, $userPassword)
    {
        $subject = 'Welcome to ' . htmlspecialchars($userName);
        $body = '
                <html>
                <head>
                    <style>
        ...
        // $apiUrl = 'https://xtag.email.service.serviceinhand.com/api/sender/text';
        // $apiKey = 'uzNZHAvOPIgFkoW4CpV7Ztl3lULjQkOkiS2Itf7LNc4zUICOQejwmHfgOPWdd2SHpmA7Nscem1JUO33tKc1ffsFIiQzyPyygEjaXS';
